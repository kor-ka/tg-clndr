...
const Month = React.memo(({ startDate, scrollInto, intersectionObserver }: { startDate: Date, scrollInto?: { date: number }, intersectionObserver?: IntersectionObserver }) => {
    ...
    return <div
        ...
        <div ref={titleRef} style={{ display: 'flex', alignSelf: 'flex-end', height: calTitleHeight, alignItems: 'center', paddingRight: 20, fontWeight: 600 }}>{startDate.toLocaleDateString('en-Gb', { month: 'long', year: 'numeric' })}</div>
